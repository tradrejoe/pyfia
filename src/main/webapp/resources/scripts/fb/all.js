/*1407883226,,JIT Construction: v1366099,en_US*/
/**
...
try {
    window.FB || (function(window) {
        ...
        __d("ES", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3", "ES6Object"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            ...
            function t(u, v, w) {
                var x = Array.prototype.slice.call(arguments, 3),
                    y = w ? o.call(u).slice(8, -1) + '.prototype' : u,
                    z = p[y + '.' + v] || u[v];
        ...
        __d("sdk.createIframe", ["guid", "hasNamePropertyBug", "DOMEventListener"], function(a, b, c, d, e, f, g, h, i) {
            function j(k) {
                ...
                delete s.width;
                for (var t in s)
                    if (s.hasOwnProperty(t)) l.setAttribute(t, s[t]);
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            ...
            function ga() {
                var la = Array.prototype.slice.call(arguments, 0),
                    ...
                    pa = ma.params,
                    qa = pa.method,
                    ra = na.getProtocol() && na.getDomain() ? na.setQueryData({}).toString() : q.resolve('graph') + na.getPath();
            ...
            function ha() {
                var la = Array.prototype.slice.call(arguments, 0),
                    ...
                    ra = {
                        method: qa,
                        relative_url: na.removeQueryData('method').toString()
                    };
            ...
            var w = n.extend({
                ...
                x = {
                    ...
                    create: function(y) {
                        ...
                        } else ba += o.mobile() ? ' fb_dialog_mobile' : ' fb_dialog_advanced'; if (y.content) h.append(y.content, aa);
                        z.className = ba;
                ...
                da = {
                    ...
                    checkOauthDisplay: function(ea) {
                        ...
                        for (var ha = 0; ha < ga.length; ha++)
                            if (!x.initSitevars.iframePermissions[ES(ga[ha], 'trim', true)]) return 'popup';
                        return ea.display;
                    },
        ...
        __d("mergeArrays", [], function(a, b, c, d, e, f) {
            function g(h, i) {
                for (var j = 0; j < i.length; j++)
                    if (ES(h, 'indexOf', true, i[j]) < 0) h.push(i[j]);
                return h;
            }
            e.exports = g;
        }, null);
            ...
            var n = j.extend({
                process: function() {
                    ...
                    if (this._firstnameonly) {
                        ...
                        o.push('last_name');
                    } else o.push('name'); if (this._subjectId) {
                        o.push('gender');
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1366099","message":"' + e.message + '"}}');
}